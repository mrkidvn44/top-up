...
type OrderConfirmRequest struct {
	...
	CardDetailId  uint32                 `protobuf:"varint,3,opt,name=card_detail_id,json=cardDetailId,proto3" json:"card_detail_id,omitempty"`
	...
	CashBackValue int32                  `protobuf:"varint,7,opt,name=cash_back_value,json=cashBackValue,proto3" json:"cash_back_value,omitempty"`
...
func (x *OrderConfirmRequest) GetOrderId() uint32 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
func (x *OrderConfirmRequest) GetUserId() uint32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *OrderConfirmRequest) GetCardDetailId() uint32 {
	if x != nil {
...
func (x *OrderConfirmRequest) GetTotalPrice() int32 {
	if x != nil {
		return x.TotalPrice
	}
	return 0
...
func (x *OrderConfirmRequest) GetCashBackValue() int32 {
	if x != nil {
...
const file_proto_order_proto_rawDesc = "" +
	...
	"\x0ecard_detail_id\x18\x03 \x01(\rR\fcardDetailId\x12\x1f\n" +
	"\vtotal_price\x18\x04 \x01(\x05R\n" +
	"totalPrice\x12\x16\n" +
	"\x06status\x18\x05 \x01(\tR\x06status\x12!\n" +
	"\fphone_number\x18\x06 \x01(\tR\vphoneNumber\x12&\n" +
	"\x0fcash_back_value\x18\a \x01(\x05R\rcashBackValue\"F\n" +
